...
class OperacionPrincipalController {
  ...
  public async ListaMensualAnoMesTipoOrigen(req: Request, res: Response) {
    ...
    await pool.query(
      'SELECT * FROM OperacionPrincipal WHERE Ano = ? and Mes = ? and TipoOrigen = ? and Id_Proyecto=? Order by FechaOperacion',
      [ano, mes, tipoOrigen, id_Proyecto],
  ...
  public async MaxNumeroOperacion(req: Request, res: Response) {
    ...
    await pool.query(
      'SELECT MAX(Numero) as Maximo FROM OperacionPrincipal WHERE Ano = ? and Mes = ? and TipoOrigen = ? and Id_Proyecto = ?',
      [ano, mes, tipoOrigen, id_Proyecto],
